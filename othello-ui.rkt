...
;; Racket-line added 2016 by Anders M.L.

;; Please note that this is not necessarily in good Racket GUI programming
;; style. Feel free to modify. This is an old bare-bones skeleton using
;; semaphores and waits where the ambitious student might want to write a
